...
nlpcc_test_bleu_scores = bleu_score(nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt_address,
                                    nlpcc2018_kbqa_test_knowques_compansw_no_temp_prompt_address)
print('nlpcc2018_no_temp_prompt的bleu值为：', nlpcc_test_bleu_scores)