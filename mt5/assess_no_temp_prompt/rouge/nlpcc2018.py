...
nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt_address = '../../mt5_model_gene_answer_no_temp_prompt/nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt.json'
nlpcc2018_kbqa_test_knowques_compansw_no_temp_prompt_address = '../../data_no_temp_prompt/nlpcc2018_test_data_no_temp_prompt.json'
...
nlpcc_rouge1_r_scores, nlpcc_rouge2_r_scores, nlpcc_rouge3_r_scores = get_rouge_r_test(
    nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt_address,
    nlpcc2018_kbqa_test_knowques_compansw_no_temp_prompt_address)
nlpcc_rouge1_f_scores, nlpcc_rouge2_f_scores, nlpcc_rouge3_f_scores = get_rouge_f_test(
    nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt_address,
    nlpcc2018_kbqa_test_knowques_compansw_no_temp_prompt_address)
nlpcc_rouge1_p_scores, nlpcc_rouge2_p_scores, nlpcc_rouge3_p_scores = get_rouge_p_test(
    nlpcc2018_kbqa_test_model_gene_answer_no_temp_prompt_address,
    nlpcc2018_kbqa_test_knowques_compansw_no_temp_prompt_address)
# print('平均rouge1_r分数为：', nlpcc_rouge1_r_scores)
print('nlpcc2018_no_temp_prompt的平均rouge2_r分数为：', nlpcc_rouge2_r_scores)
