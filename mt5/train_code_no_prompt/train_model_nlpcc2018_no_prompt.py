...
nlpcc2018_kbqa_train_knowques_compansw_no_prompt_address = '../data_no_prompt/nlpcc2018_kbqa_train_knowques_compansw_no_prompt.json'
nlpcc2018_kbqa_dev_knowques_compansw_no_prompt_address = '../data_no_prompt/nlpcc2018_kbqa_dev_knowques_compansw_no_prompt.json'
nlpcc2018_kbqa_test_knowques_compansw_no_prompt_address = '../data_no_prompt/nlpcc2018_kbqa_test_knowques_compansw_no_prompt.json'

with open(nlpcc2018_kbqa_train_knowques_compansw_no_prompt_address, 'r', encoding='utf-8') as f:
    nlpcc2018_train_data_no_prompt = json.load(f)
with open(nlpcc2018_kbqa_dev_knowques_compansw_no_prompt_address, 'r', encoding='utf-8') as f:
    nlpcc2018_dev_data_no_prompt = json.load(f)
...
train_data = nlpcc2018_train_data_no_prompt
dev_data = nlpcc2018_dev_data_no_prompt
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model_no_prompt/mt5_nlpcc2018_no_prompt.pkl')
