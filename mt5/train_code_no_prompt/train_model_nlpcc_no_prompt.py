...
with open(nlpcc_kbqa_train_knowques_compansw_address, 'r', encoding='utf-8') as f:
    nlpcc_train_data_no_prompt = json.load(f)
with open(nlpcc_kbqa_dev_knowques_compansw_address, 'r', encoding='utf-8') as f:
    nlpcc_dev_data_no_prompt = json.load(f)
...
train_data = nlpcc_train_data_no_prompt
dev_data = nlpcc_dev_data_no_prompt
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model_no_prompt/mt5_nlpcc_no_prompt.pkl')
