...
from mt5.train_code_no_temp.train_model_ccks2020_no_temp import T5FineTuner, mt5Dataset
import torch
import json
import random
import numpy as np
...
model = torch.load('../mt5_trained_model_no_temp/mt5_ccks2020_no_temp.pkl')
...
for i in tqdm(ccks2020_test_data):
    # if idx <20:
    item = i[0]
...
with open(ccks2020_kbqa_test_model_gene_answer_no_temp_address, 'w', encoding='utf-8') as f:
