...
from train_code_no_temp.train_model_nlpcc2018_no_temp import T5FineTuner, mt5Dataset
import torch
import json
import random
import numpy as np
...
model = torch.load('../mt5_trained_model_no_temp/mt5_nlpcc2018_no_temp.pkl')
...
with open(nlpcc2018_kbqa_test_knowques_compansw_no_temp_address, 'r', encoding='utf-8') as f:
...
with open(nlpcc2018_kbqa_test_model_gene_answer_no_temp_address, 'w', encoding='utf-8') as f:
