...
from train_code_no_temp.train_model_kgclue_no_temp import T5FineTuner, mt5Dataset
import torch
import json
import random
import numpy as np
...
model = torch.load('../mt5_trained_model_no_temp/mt5_kgclue_no_temp.pkl')
...
with open(kgclue_kbqa_test_model_gene_answer_no_temp_address, 'w', encoding='utf-8') as f:
