...
nlpcc2018_s_po_address = '../data/nlpcc2018_s_po.json'
nlpcc2018_ques_answ_address = '../data/nlpcc2018_ques_answ.json'
know_ques_answ_address = '../data_no_prompt/nlpcc2018_know_ques_answ_no_prompt.json'

with open(nlpcc2018_s_po_address, 'r', encoding='utf-8') as f:
    s_po_list = json.load(f)
with open(nlpcc2018_ques_answ_address, 'r', encoding='utf-8') as f:
