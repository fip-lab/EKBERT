...
def one_hop_raw_process(address):
    ...
    for item in train_triples_pro:
        ...
        compansw = know_s + '的' + know_p + '是' + know_o  # p是o
        if compansw[-1] == ',':
...
ccks2020_kbqa_train_knowques_compansw_address = '../data_no_prompt/ccks2020_kbqa_train_knowques_compansw.json'
ccks2020_kbqa_dev_knowques_compansw_address = '../data_no_prompt/ccks2020_kbqa_dev_knowques_compansw.json'
ccks2020_kbqa_test_knowques_compansw_address = '../data_no_prompt/ccks2020_kbqa_test_knowques_compansw.json'
