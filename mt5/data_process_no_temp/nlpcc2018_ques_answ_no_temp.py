...
nlpcc_2018_ques_answ_no_temp_address = '../data_no_temp/nlpcc2018_ques_answ_no_temp.json'
...
if __name__ == '__main__':
    ...
    with open(nlpcc_2018_ques_answ_no_temp_address, 'w', encoding='utf-8') as f:
