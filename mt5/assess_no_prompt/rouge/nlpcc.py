...
nlpcc_kbqa_test_model_gene_answer_address = '../../mt5_model_gene_answer_no_prompt/nlpcc_kbqa_test_model_gene_answer_no_prompt.json'
...
print('nlpcc2016_no_prompt的平均rouge2_r分数为：', nlpcc_rouge2_r_scores)
