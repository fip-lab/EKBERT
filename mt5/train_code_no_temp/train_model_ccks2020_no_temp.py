...
train_data = ccks2020_train_data
dev_data = ccks2020_dev_data
...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        return DataLoader(train_dataset, batch_size=3, num_workers=4, shuffle=True)

    def val_dataloader(self):
        return DataLoader(dev_dataset, batch_size=3, num_workers=4)
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model_no_temp/mt5_ccks2020_no_temp.pkl')
