...
with open(nlpcc2018_train_data_no_temp_address, 'r', encoding='utf-8') as f:
    nlpcc2018_train_data_no_temp = json.load(f)
with open(nlpcc2018_dev_data_no_temp_address, 'r', encoding='utf-8') as f:
    nlpcc2018_dev_data_no_temp = json.load(f)
...
train_data = nlpcc2018_train_data_no_temp
dev_data = nlpcc2018_dev_data_no_temp
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model_no_temp/mt5_nlpcc2018_no_temp.pkl')
