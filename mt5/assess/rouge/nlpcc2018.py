...
nlpcc2018_kbqa_test_model_gene_answer_address = '../../mt5_model_gene_answer/nlpcc2018_kbqa_test_model_gene_answer.json'
nlpcc2018_kbqa_test_knowques_compansw_address = '../../data/nlpcc2018_test_data.json'
...
print('nlpcc2018平均rouge2_r分数为：', nlpcc_rouge2_r_scores)
