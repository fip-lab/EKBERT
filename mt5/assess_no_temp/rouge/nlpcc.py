...
nlpcc_rouge1_r_scores, nlpcc_rouge2_r_scores, nlpcc_rouge3_r_scores = get_rouge_r_test(nlpcc_kbqa_test_model_gene_answer_no_temp_address,
                                                                                  nlpcc_kbqa_test_knowques_compansw_no_temp_address)
nlpcc_rouge1_f_scores, nlpcc_rouge2_f_scores, nlpcc_rouge3_f_scores = get_rouge_f_test(nlpcc_kbqa_test_model_gene_answer_no_temp_address,
                                                                                  nlpcc_kbqa_test_knowques_compansw_no_temp_address)
nlpcc_rouge1_p_scores, nlpcc_rouge2_p_scores, nlpcc_rouge3_p_scores = get_rouge_p_test(nlpcc_kbqa_test_model_gene_answer_no_temp_address,
                                                                                  nlpcc_kbqa_test_knowques_compansw_no_temp_address)
# print('平均rouge1_r分数为：', nlpcc_rouge1_r_scores)
print('nlpcc2016_no_temp的平均rouge2_r分数为：', nlpcc_rouge2_r_scores)
