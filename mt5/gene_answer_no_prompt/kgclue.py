...
from train_code_no_prompt.train_model_kgclue_no_prompt import T5FineTuner, mt5Dataset
import torch
import json
import random
import numpy as np
...
model = torch.load('../mt5_trained_model_no_prompt/mt5_kgclue_no_prompt.pkl')
kgclue_kbqa_test_model_gene_answer_address = '../mt5_model_gene_answer_no_prompt/kgclue_kbqa_test_model_gene_answer_no_prompt.json'
kgclue_kbqa_test_knowques_compansw_address = '../data_no_prompt/kgclue_test_knowques_compansw_no_prompt.json'
