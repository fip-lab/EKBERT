...
from train_code_no_prompt.train_model_nlpcc_no_prompt import T5FineTuner, mt5Dataset
import torch
import json
import random
import numpy as np
...
model = torch.load('../mt5_trained_model_no_prompt/mt5_nlpcc_no_prompt.pkl')
