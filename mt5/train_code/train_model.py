...
t5_model = T5ForConditionalGeneration.from_pretrained('google/mt5-base',
                                                      cache_dir='../mt5_base_model')
...
class T5FineTuner(pl.LightningModule):
    ...
    def val_dataloader(self):
        return DataLoader(dev_dataset, batch_size=1, num_workers=4, shuffle=True)
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model/mt5_5.pkl')

# mt5_3 未添加随机种子 mt5_4 random.seed(42)  mt5_5 nlpcc 7:2:1
