...
t5_tokenizer = T5Tokenizer.from_pretrained('../mt5_small_model')
t5_model = T5ForConditionalGeneration.from_pretrained('../mt5_small_model')
...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        return DataLoader(train_dataset, batch_size=2, num_workers=4, shuffle=True)

    def val_dataloader(self):
        return DataLoader(dev_dataset, batch_size=2, num_workers=4)
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../mt5_trained_model/mt5_ccks2022_small.pkl')
