...
def get_entity_id():
    ...
    with open(os.path.join(data_path, 'kb_data'), 'r') as f:
        for line in f:
...
if __name__ == '__main__':
    entity_embedding()
    get_input_bert(os.path.join(data_path, 'train.json'), 'data/ER_input_train_match.pkl')
    # get_input_bert_test('original_data/eval722.json', 'data/input_eval_match_bert.pkl')
    get_input_bert_test(os.path.join(data_path, 'train.json'), 'data/input_eval_match_bert.pkl')
    pass
