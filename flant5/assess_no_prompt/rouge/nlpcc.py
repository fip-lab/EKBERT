...
nlpcc_kbqa_test_knowques_compansw_address = '../../../mt5/data_no_prompt/nlpcc_kbqa_test_knowques_compansw.json'
nlpcc_kbqa_test_model_gene_answer_address = '../../flant5_model_gene_answer_no_prompt/nlpcc_kbqa_test_model_gene_answer_no_prompt.json'
