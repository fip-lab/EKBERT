...
kgclue_kbqa_train_knowques_compansw_address = '../../mt5/data/kgclue_train_data.json'
kgclue_kbqa_dev_knowques_compansw_address = '../../mt5/data/kgclue_dev_data.json'
kgclue_kbqa_test_knowques_compansw_address = '../../mt5/data/kgclue_test_data.json'



with open(kgclue_kbqa_train_knowques_compansw_address, 'r', encoding='utf-8') as f:
    kgclue_train_data = json.load(f)
with open(kgclue_kbqa_dev_knowques_compansw_address, 'r', encoding='utf-8') as f:
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../flant5_trained_model/mt5_kgclue.pkl')
