...
kgclue_train_data_no_temp_address = '../../mt5/data_no_temp/kgclue_train_data_no_temp.json'
kgclue_dev_data_no_temp_address = '../../mt5/data_no_temp/kgclue_dev_data_no_temp.json'
kgclue_test_data_no_temp_address = '../../mt5/data_no_temp/kgclue_test_data_no_temp.json'

with open(kgclue_train_data_no_temp_address, 'r', encoding='utf-8') as f:
    kgclue_train_data_no_temp = json.load(f)
with open(kgclue_dev_data_no_temp_address , 'r', encoding='utf-8') as f:
    kgclue_dev_data_no_temp = json.load(f)
...
train_data = kgclue_train_data_no_temp
dev_data = kgclue_dev_data_no_temp
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../flant5_trained_model_no_temp/mt5_kgclue_no_temp.pkl')
