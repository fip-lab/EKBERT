...
nlpcc_kbqa_train_knowques_compansw_address = '../../mt5/data_no_temp/nlpcc_kbqa_train_knowques_compansw.json'
nlpcc_kbqa_dev_knowques_compansw_address = '../../mt5/data_no_temp/nlpcc_kbqa_dev_knowques_compansw.json'
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../flant5_trained_model_no_temp/mt5_nlpcc_no_temp.pkl')
