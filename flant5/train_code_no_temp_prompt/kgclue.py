...
kgclue_train_data_no_temp_prompt_address = '../../mt5/data_no_temp_prompt/kgclue_train_data_no_temp_prompt.json'
kgclue_dev_data_no_temp_prompt_address = '../../mt5/data_no_temp_prompt/kgclue_dev_data_no_temp_prompt.json'
kgclue_test_data_no_temp_prompt_address = '../../mt5/data_no_temp_prompt/kgclue_test_data_no_temp_prompt.json'

with open(kgclue_train_data_no_temp_prompt_address, 'r', encoding='utf-8') as f:
    kgclue_train_data_no_temp_prompt = json.load(f)
with open(kgclue_dev_data_no_temp_prompt_address, 'r', encoding='utf-8') as f:
    kgclue_dev_data_no_temp_prompt = json.load(f)
...
train_data = kgclue_train_data_no_temp_prompt
dev_data = kgclue_dev_data_no_temp_prompt
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../flant5_trained_model_no_temp_prompt/mt5_kgclue_no_temp_prompt.pkl')
