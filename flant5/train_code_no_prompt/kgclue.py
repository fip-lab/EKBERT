...
kgclue_train_knowques_compansw_no_prompt_address = '../../mt5/data_no_prompt/kgclue_train_knowques_compansw_no_prompt.json'
kgclue_dev_knowques_compansw_no_prompt_address = '../../mt5/data_no_prompt/kgclue_dev_knowques_compansw_no_prompt.json'
kgclue_test_knowques_compansw_no_prompt_address = '../../mt5/data_no_prompt/kgclue_test_knowques_compansw_no_prompt.json'
...
if __name__ == '__main__':
    ...
    trainer.fit(model)
    torch.save(model, '../flant5_trained_model_no_prompt/mt5_kgclue_no_prompt.pkl')
