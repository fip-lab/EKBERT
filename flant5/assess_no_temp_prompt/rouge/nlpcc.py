...
nlpcc_kbqa_test_model_gene_answer_no_temp_prompt_address = '../../flant5_model_gene_answer_no_temp_prompt/nlpcc_kbqa_test_model_gene_answer_no_temp_prompt.json'
nlpcc_kbqa_test_knowques_compansw_no_temp_prompt_address = '../../../mt5/data_no_temp_prompt/nlpcc_kbqa_test_knowques_compansw.json'
...
nlpcc_rouge1_r_scores, nlpcc_rouge2_r_scores, nlpcc_rouge3_r_scores = get_rouge_r_test(
    nlpcc_kbqa_test_model_gene_answer_no_temp_prompt_address,
    nlpcc_kbqa_test_knowques_compansw_no_temp_prompt_address)
...
print('nlpcc2016_no_temp_prompt的平均rouge2_r分数为：', nlpcc_rouge2_r_scores)
