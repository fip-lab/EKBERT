...
kgclue_chatgpt_answer_address = '../data/kgclue_answer.txt'
kgclue_comp_answer_address = '../../mt5/data/kgclue_test_data.json'
...
nlpcc_test_bleu_scores = bleu_score(kgclue_chatgpt_answer_address,
                                    kgclue_comp_answer_address)
