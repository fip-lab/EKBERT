...
sys.setrecursionlimit(100000)  # 递归次数超出默认，这里设置为十万

ccks2022_kbqa_test_model_gene_answer_address = '../data/ccks2022_answer.txt'
...
ccks2022_rouge1_r_scores, ccks2022_rouge2_r_scores, ccks2022_rouge3_r_scores = get_rouge_r_test(
    ccks2022_kbqa_test_model_gene_answer_address,
    ccks2022_kbqa_test_knowques_compansw_address)
ccks2022_rouge1_f_scores, ccks2022_rouge2_f_scores, ccks2022_rouge3_f_scores = get_rouge_f_test(
    ccks2022_kbqa_test_model_gene_answer_address,
    ccks2022_kbqa_test_knowques_compansw_address)
ccks2022_rouge1_p_scores, ccks2022_rouge2_p_scores, ccks2022_rouge3_p_scores = get_rouge_p_test(
    ccks2022_kbqa_test_model_gene_answer_address,
    ccks2022_kbqa_test_knowques_compansw_address)
print('平均rouge1_r分数为：', ccks2022_rouge1_r_scores)
print('平均rouge2_r分数为：', ccks2022_rouge2_r_scores)
print('平均rouge3_r分数为：', ccks2022_rouge3_r_scores)

print('平均rouge1_f分数为：', ccks2022_rouge1_f_scores)
print('平均rouge2_f分数为：', ccks2022_rouge2_f_scores)
print('平均rouge3_f分数为：', ccks2022_rouge3_f_scores)

print('平均rouge1_p分数为：', ccks2022_rouge1_p_scores)
print('平均rouge2_p分数为：', ccks2022_rouge2_p_scores)
print('平均rouge3_p分数为：', ccks2022_rouge3_p_scores)
