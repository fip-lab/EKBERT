...
cd src
# md 任务
md_train_name='../output/finetune_model/ccks_el_ekbert_md'
md_model_dir='../output/finetune_model/ccks_el_ekbert_md'
md_data_dir='../src/data/processed/ccks_el_2019/md'
# ed任务
ed_train_name='../output/finetune_model/ccks_el_ekbert_ed'
ed_model_dir='../output/finetune_model/ccks_el_ekbert_ed'
ed_data_dir='../src/data/processed/ccks_el_2019/ed_ekbert'
