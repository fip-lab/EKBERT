...
train_name='../output/finetune_model/ccks_kbqa_ekbert_ed'
model_dir='../output/finetune_model/ccks_kbqa_ekbert_ed'
data_dir='../src/data/processed/ccks_kbqa_2020/ed_ekbert'
device=0
