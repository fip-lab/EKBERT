...
cd src
# md 任务
md_train_name='../output/finetune_model/nlpcc_kbqa_ekbert_md'
md_model_dir='../output/finetune_model/nlpcc_kbqa_ekbert_md'
md_data_dir='../src/data/processed/nlpcc_kbqa/md'
# ed任务
ed_train_name='../output/finetune_model/nlpcc_kbqa_ekbert'
ed_model_dir='../output/finetune_model/nlpcc_kbqa_ekbert'
ed_data_dir='../src/data/processed/nlpcc_kbqa/ed_ekbert'
