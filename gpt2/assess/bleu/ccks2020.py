...
ccks2020_test_bleu_scores = bleu_score(ccks2020_kbqa_test_model_gene_answer_address,
                                    ccks2020_kbqa_test_knowques_compansw_address)
print('ccks2020的bleu值为：', ccks2020_test_bleu_scores)