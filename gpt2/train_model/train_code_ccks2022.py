...
train_data1 = train_data + dev_data
train_dataset = TextDataset(train_data1, tokenizer, max_length)
...
# 保存模型
output_dir = '../gpt2_trained_model/gpt2_trained_model_ccks2022'
