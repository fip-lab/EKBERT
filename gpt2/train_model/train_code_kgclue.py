...
with open(kgclue_kbqa_train_knowques_compansw_new_address, 'r', encoding='utf-8') as f:
    kgclue_train_data = json.load(f)
with open(kgclue_kbqa_dev_knowques_compansw_new_address, 'r', encoding='utf-8') as f:
...
# 保存模型
output_dir = '../gpt2_trained_model/gpt2_trained_model_kgclue'
