...
with open(ccks2022_kbqa_test_knowques_compansw_new_inp_address, 'r', encoding='utf-8') as f:
    ccks2022_kbqa_test_knowques_compansw_new_inp = json.load(f)
# 加载训练好的模型和分词器
tokenizer = BertTokenizer.from_pretrained('../gpt2_trained_model/gpt2_trained_model_ccks2022')
model = GPT2LMHeadModel.from_pretrained('../gpt2_trained_model/gpt2_trained_model_ccks2022')
...
for text in tqdm(ccks2022_kbqa_test_knowques_compansw_new_inp):
#     if idx <20:
