...
nlpcc2018_kbqa_test_knowques_compansw_new_inp_address = '../data/nlpcc2018_kbqa_test_knowques_compansw_single_inp.json'
nlpcc2018_kbqa_test_model_gene_answer_address = '../gpt2_model_gene_answer/nlpcc2018_kbqa_test_model_gene_answer.json'

with open(nlpcc2018_kbqa_test_knowques_compansw_new_inp_address, 'r', encoding='utf-8') as f:
    nlpcc2018_kbqa_test_knowques_compansw_new_inp = json.load(f)
# 加载训练好的模型和分词器
tokenizer = BertTokenizer.from_pretrained('../gpt2_trained_model/gpt2_trained_model_nlpcc2018')
model = GPT2LMHeadModel.from_pretrained('../gpt2_trained_model/gpt2_trained_model_nlpcc2018')
...
for text in tqdm(nlpcc2018_kbqa_test_knowques_compansw_new_inp):
#     if idx <20:
