...
nlpcc_kbqa_train_knowques_compansw_new_address = '../data/nlpcc_kbqa_train_knowques_compansw_new.json'
nlpcc_kbqa_dev_knowques_compansw_new_address = '../data/nlpcc_kbqa_dev_knowques_compansw_new.json'
nlpcc_kbqa_test_knowques_compansw_new_address = '../data/nlpcc_kbqa_test_knowques_compansw_new.json'
