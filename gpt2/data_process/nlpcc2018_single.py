...
if __name__ == '__main__':
    nlpcc_new_train_answ_data = create_new_answer_data(nlpcc2018_train_data)
    # print(nlpcc_new_answ_data)
    nlpcc_new_dev_answ_data = create_new_answer_data(nlpcc2018_dev_data)
    nlpcc_new_test_answ_data = create_new_answer_data(nlpcc2018_test_data)
