...
class bartFineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        return DataLoader(train_dataset, batch_size=16, num_workers=16, shuffle=True)

    def val_dataloader(self):
        return DataLoader(dev_dataset, batch_size=16, num_workers=16)
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(max_epochs=3, gpus=4, strategy="dp")

    trainer.fit(model)
    torch.save(model, '../bart_trained_model/bart_nlpcc_3.pkl')
